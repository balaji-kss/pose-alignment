...
def cross_sim_video_align():      
    ...
    template_names  = ["baseline11"] * 6 # "baseline-IMG_0032" # "baseline"
    candidate_names = ["baseline14", "baseline16", "baseline17","candidate1", "candidate2", "candidate3"] # "baseline14", "baseline17", "candidate1", "candidate2", "candidate3"] # "candidate-IMG_0033" # "candidate-good"
