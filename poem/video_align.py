...
def cross_sim_video_align():      
    ...
    template_names  = ["baseline13"] * 3 # "baseline-IMG_0032" # "baseline"
    candidate_names = ["candidate1", "candidate2", "candidate3"] # "baseline14", "baseline17", "candidate1", "candidate2", "candidate3"] # "candidate-IMG_0033" # "candidate-good"
...
if __name__ == "__main__":
    ...
    input_dirs = ["/home/tumeke-balaji/Documents/results/delta/input_videos/delta_all_data/delta_data/Serving_from_Basket/"]
